...
public class H_DetailsActivity extends ActionBarActivity {
	...
	protected void onStart() {
		...
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(H_DetailsActivity.this);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(MainActivity.AppTheme == 1) dl.setBackgroundColor(Color.BLACK);
		...
		for(int i = 0;i < 101;i++) {
			...
			if(!homework.equals("-")) {
				...
				String item_text = homework.substring(index2 +1, index3);
				String item_from = homework.substring(index3 +1);
