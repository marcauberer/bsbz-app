...
public boolean onCreateOptionsMenu(Menu menu) {
    ...
    public static class NewsFragment extends ListFragment {
        ...
        public void onActivityCreated(@Nullable Bundle savedInstanceState) {
            ...
            String item_from;
            String item_state;
            String item_activation_date;
            String item_expiration_date;
            String receiver;
            for(int i = 0; i < 101; i++) {
                ...
                if(!news.equals("-")) {
                    ...
                    receiver = news.substring(index6 +1);
                    if(showInvisibleEntries) {
                        if(!item_subject.equals("-") && !item_subject.equals("")) {
                            arraylist.add(item_from +": "+ item_subject);
                            arraylist_main.add(item_from +": "+ item_subject);
                        }
                    } else {
                        if(!item_subject.equals("-") && !item_subject.equals("") && item_state.equals("1")) {
                            arraylist.add(item_from +": "+ item_subject);
                            arraylist_main.add(item_from +": "+ item_subject);
                        }
                    }
        ...
        public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
            ...
            inflater.inflate(R.menu.new_fragment_context_menu, menu);
        }
        ...
        public void onListItemClick(ListView l, View v, int position, long id) {
            ...
            String item_title = l.getItemAtPosition(position).toString();
            ...
            for(int i = 0; i < 101; i++) {
                ...
                if(!news.equals("-")) {
                    ...
                    if(showInvisibleEntries) {
                        if(!item_subject.equals("-") && !item_subject.equals("")) {
                            if(item_title.equals(item_from + ": " + item_subject)) {
                                arraylist.add(item_from + ": " + item_subject + ":\n\n" + item_description);
                            } else {
                                arraylist.add(item_from + ": " + item_subject);
                            }
