...
public class T_DetailsActivity extends ActionBarActivity {
	...
	protected void onStart() {
		...
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(T_DetailsActivity.this);
